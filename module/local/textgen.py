    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        if self.streaming:
            ...
            if self.stopping_strings:
                request["stop"] = self.stopping_strings
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ImportError(
                "The `sseclient-py` package is required for streaming."
            )
        ...
        request["stream"] = True
        # print(request)
        stream_response = requests.post(url, json=request, verify=False, stream=True)
